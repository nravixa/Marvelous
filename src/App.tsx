  ...
  return (
    <HelmetProvider>
      <div className="flex flex-col min-h-screen bg-obsidian text-cream antialiased selection:bg-gold selection:text-obsidian overflow-x-hidden">
        ...
        <Helmet>
          <title>Salon | Luxury Beauty Services</title>
          <meta name="description" content="Experience premium beauty services, hair styling, skin care, bridal makeup, and professional beauty courses at Salon." />
          <link rel="canonical" href="https://salon-academy.com" />
        </Helmet>
