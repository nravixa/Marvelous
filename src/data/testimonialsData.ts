...
export const testimonialsData: Testimonial[] = [
  ...
  },
  {
    ...
    name: 'Dheeraj Kamble',
    rating: 5,
    review: "I've been visiting Salon for the past three years, and I can't recommend it enough—especially my hairstylist, Vikram. He took the time to understand my concerns, guided me properly, and helped restore my hairline after a bad experience elsewhere. His professionalism, consistency, and skill have brought back my confidence. Thank you, Salon and Vikram, for the fantastic service every single time!",
