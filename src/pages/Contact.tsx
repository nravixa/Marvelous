...
import { MapPin, Send, Sparkles, ChevronDown, Clock, Instagram } from 'lucide-react';
        ...
        <div className="lg:col-span-5 flex flex-col gap-10">
          ...
          <ul className="flex flex-col gap-6 text-sm text-cream/80 font-light">
            <li className="flex gap-4 items-start">
              ...
              <div>
                <span className="block text-xs uppercase tracking-widest text-cream/40 mb-1">Campus Location</span>
                <span>Pune</span>
              </div>
            </li>
            <li className="flex gap-4 items-start">
            ...
            <li className="flex gap-4 items-center">
              ...
              <div>
                ...
                <a href="#" onClick={(e) => e.preventDefault()} className="hover:text-gold transition-colors font-medium">@salon</a>
              </div>
            </li>
          </ul>
              ...
              {isSubmitted && (
                <div className="absolute inset-0 bg-obsidian/95 backdrop-blur-md z-10 flex flex-col items-center justify-center p-6 text-center">
                  ...
                  <p className="text-cream/60 max-w-md text-xs leading-relaxed font-light">
                    Thank you for connecting with Salon. We have received your inquiry.
                  </p>
                </div>
              )}
