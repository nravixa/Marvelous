  ...
  const founders = [
    {
      ...
      description: 'Julian Sterling founded Salon & Academy with a vision to deliver world-class luxury beauty services and high-quality professional academy training to aspiring beauty artists.',
        ...
        <div>
          <FadeIn direction="left">
            ...
            <p className="text-cream/70 font-light text-sm leading-relaxed mb-6">
              Salon & Academy provides premium salon services for men, women, and children while maintaining high standards of hygiene, professionalism, and customer satisfaction.
            </p>
            <p className="text-cream/70 font-light text-sm leading-relaxed mb-6">
              Julian Sterling recognized that many stylists were entering the industry with poor knowledge of dermal biology, cosmetic safety, and salon business analytics. By combining a luxury service salon with a state-of-the-art academy, Salon created a cyclic system of excellence. Students train directly under the guidance of senior directors, observing real-world client consultations and advanced coloring formulas.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <FadeIn direction="up">
              ...
              <h2 className="font-serif text-3xl md:text-4xl font-light text-cream">The Pillars of Excellence</h2>
            </FadeIn>
          </div>
